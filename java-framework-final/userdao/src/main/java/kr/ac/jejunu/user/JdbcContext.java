...
public class JdbcContext {
    ...
    User jdbcContextForGet(Integer id, StatementStrategy statementStrategy) throws SQLException {
    ...
    User get(Integer id, Object[] params, String sql) throws SQLException {
